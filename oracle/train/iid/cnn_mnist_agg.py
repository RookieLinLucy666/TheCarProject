...
for i in range(1, node_count):
    path_checkpoint = "train/iid/checkpoint/mnist/ckpt_" + str(i) + "_" + str(local_epoch-1) + ".pth"  # 断点路径
...
torch.save(checkpoint, 'train/iid/checkpoint/agg/mnist_ckpt_'+ str(current_rounds) + ".pth")
