...
//合约账户转账
//给合约账户转账：./xchain-cli transfer --to XC1234567890111112@xuper --amount 1000000000000
...
//在output目录下：./xchain-cli wasm deploy --account XC1234567890111111@xuper --cname gocounter -a '{"creator":"xchain"}' ./counter --runtime go
func NativeContract() {
