...
func (c *ResultController) URLMapping() {
	...
	c.Mapping("GetOneByBcId", c.GetOneByBcId)
}
...
func (c *ResultController) GetOne() {
	fmt.Println("this is result getone")
...
// GetOneByBcId
// @router /getonebybcid/:bcid [get]
func (c* ResultController) GetOneByBcId()  {
	fmt.Println("this is bcid getone")
	bcid := c.GetString("bcid")
	fmt.Println(bcid)
	v, err := models.GetOneResultByBcId(bcid)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		c.Data["json"] = v
