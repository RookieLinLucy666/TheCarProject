...
--
-- Host: localhost    Database: the_car_project
-- ------------------------------------------------------
...
CREATE TABLE `metadata` (
  ...
  `bc_id` varchar(128) DEFAULT NULL,
...
CREATE TABLE `user` (
  ...
  `chain_status` char(32) DEFAULT NULL,
  `abstract` char(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `user` VALUES (1,'Mengeshall','fail','123456');
...
-- Dump completed on 2021-11-01 11:09:18
